...
import contagiouscode.mirsengar.cinematicketbookingbackend.Services.ShowService;
...
public class ShowController {
          ...
          public ResponseEntity getShowsForMovieAndLocation (
                         @RequestParam ( "id") int movieId , @RequestParam (
                         "location"
          ) String location ) {
                    try {
                              List < ShowResponseDTO > response = showService.getShowsForMovieAndLocation ( movieId ,
                                                                                                            location );
                              return new ResponseEntity <> ( response , HttpStatus.ACCEPTED );
                    }
                    catch ( Exception e ) {
